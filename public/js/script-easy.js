...
function purchase(itemType) {
  ...
  const items = {
      autoClicker1: { cost: 5, effect: () => autoClickerSpeed += 1 },
      clickBooster1: { cost: 10, effect: () => clickBoosterPower += 1 },
      clickBooster2: { cost: 1000, effect: () => clickBoosterPower += 50 },
      autoClicker2: { cost: 500, effect: () => autoClickerSpeed += 50 },
      autoClicker3: { cost: 50000, effect: () => autoClickerSpeed += 2000 },
      clickBooster3: { cost: 100000, effect: () => clickBoosterPower += 2000 },
      autoClicker4: { cost: 5000000, effect: () => autoClickerSpeed += 50000 },
      clickBooster4: { cost: 10000000, effect: () => clickBoosterPower += 50000 },
      autoClicker5: { cost: 500000000, effect: () => autoClickerSpeed += 1000000 },
      clickBooster5: { cost: 1000000000, effect: () => clickBoosterPower += 1000000 },
      autoClicker6: { cost: 50000000000, effect: () => autoClickerSpeed += 10000000 },
      clickBooster6: { cost: 100000000000, effect: () => clickBoosterPower += 10000000 },
  };
